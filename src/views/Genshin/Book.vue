    ...
    <n-layout>
      <n-layout-header>
        ...
        <n-space v-show="searchShow" v-else class="space-main" :style="custStyle">
          ...
          <n-select :value="book" @update:value="handleBook" :options="relationInfo?.book" :style="ua?'width: 200px':''" />
          <n-input :value="searchName" @keyup.enter="handleNameChg" @update:value="handleName" type="text" placeholder="搜索天赋书名" :style="ua?'width: 200px':'min-width: 200px;'" />
